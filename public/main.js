...
const habitatSelect = document.querySelector("#habitat");
const traitSelect = document.querySelector("#trait");
const roleSelect = document.querySelector("#role");
const form = document.querySelector("#creator-form");
const result = document.querySelector("#result");
const randomizeButton = document.querySelector("#randomize");
const saveButton = document.querySelector("#save");
const list = document.querySelector("#saved-creatures");
const canvas = document.querySelector("#pixel-portrait");
...
const renderPixelPortrait = (species) => {
